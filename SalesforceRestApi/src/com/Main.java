   ...
   static final String USERNAME = "babavaliahmadi@gmail.com";
    ...
    public static void main(String[] args) {
      ...
      String loginURL = LOGINURL +
                          ...
                          "&username=" + USERNAME +
                          "&password=" + PASSWORD;
      //  String loginURL= "https://login.salesforce.com/services/oauth2/token?grant_type=password&client_id=3MVG9mclR62wycM0RXtUr99TxtB3x4Q9zQf66ge7HV.x_RkKmjG4X2AcKIm3XzfaH4FN0uulmkourUE.EP5t7&client_secret=3617916833270429689&username=babavaliahmadi@gmail.com&password=Resmed12345Ns7tlkKARhAgeuTy8LmbRb1r";
    ...
    public static void createLeads() {
        ...
        try {
            ...
            lead.put("FirstName", "Test REST API");
            lead.put("LastName", "New Lead");
            lead.put("Company", "bispsolutions.com");
           ...
           // int statusCode = 201;
            ...
            if (statusCode == 201) {
            	  System.out.println("****statusCode is 201 if block--");
                String response_string = EntityUtils.toString(response.getEntity());
                JSONObject json = new JSONObject(response_string);
